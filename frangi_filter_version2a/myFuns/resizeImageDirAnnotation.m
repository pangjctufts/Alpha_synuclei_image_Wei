function resizeImageDirAnnotation(DirName,DirName2,newName,preferredW)
% Created by Jincheng Pang 07/08/2016
% Aims to creat index showing segmented results 
%
